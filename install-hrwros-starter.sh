...
wget -q "https://raw.githubusercontent.com/BuggStream/mooc_hrwros_unity_launcher/master/hrwros-mooc-icon.png" -O  ${ICONS_DIR}/hrwros-mooc-icon.png
wget -q "https://raw.githubusercontent.com/BuggStream/mooc_hrwros_unity_launcher/master/hrwros-mooc-icon-nv.png" -O  ${ICONS_DIR}/hrwros-mooc-icon-nv.png
wget -q "https://raw.githubusercontent.com/BuggStream/mooc_hrwros_unity_launcher/master/start-hrwros.desktop" -O  ${APPS_DIR}/start-hrwros.desktop
wget -q "https://raw.githubusercontent.com/BuggStream/mooc_hrwros_unity_launcher/master/start-hrwros-nvidia.desktop" -O  ${APPS_DIR}/start-hrwros-nvidia.desktop
